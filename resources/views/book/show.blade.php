...
{{-- -----生物詳細画面----- --}}
    ...
    <section>
        <div class="flex justify-around">
            ...
            <div class="w-1/2 sm:w-1/3 flex flex-col items-center">
                ...
                @else
                    <div class="mt-4 ml-2 p-4 rounded-lg w-11/12 h-56 sm:h-72 border bg-slate-50"><a href="{{ route('book.memo',$book->id ) }}" class="flex"><svg class="h-5 w-5 text-gray-500" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
    ...
    {{-- 地図選択 --}}
    <section class="flex flex-col w-[300px]">
